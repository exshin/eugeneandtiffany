...
task guest_book_index: :environment do
  ...
  guests_list = [
      ...
      ['Johnson Jou', 'David Zeng', 'George Chin', 'Jessico Cho', 'Alan Kuo', 'Emily Yu', 'Jerry Wang', 'Katie Kuo' , 'Jeff Hsieh'],
      ...
      ['George Chin','Fanny Halim','Jeff Hsieh','Anne Wu','Emily Yu','Tiffany Liu','Henry Shih','Tao Luo','Lily Liu','David Zeng','Michelle Tsai','Aaron Ho','Yuekai Sun','Hannah Lou','Miso Wu'], #22
      ...
      ['Tammy Dang','Alan Tsai','Apple Chua','Aaron Ho'], #25
      ...
      ['Wilmot Yeh','Lucy Liu','John Yu','Pheobe Yu','Toby Yeh','Snowy Wu'], #45
      ['Amy Huang','Melissa Quan','Hope Nam Phung','Michael Phung','Claire Phung','Hiromi Nakano','Julie Berger','Jennifer Hu','Eric Lin','Alexa Lin','Evelyn Saliga','George Saliga'],
      [],
